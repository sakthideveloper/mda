...
import { KtSidebarService } from './sidebar.service';
import { FuseMatchMediaService } from '@kt/services/match-media.service';
...
export class FuseSidebarComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _ktMatchMediaService: FuseMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._ktConfigService.config
            ...
            .subscribe((config) => {
                this._ktConfig = config;
            });

        // Register the sidebar
        this._ktSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._ktSidebarService.unregister(this.name);
    ...
    private _setupLockedOpen(): void
    {
        ...
        this._ktMatchMediaService.onMediaChange
            .pipe(takeUntil(this._unsubscribeAll))
            .subscribe(() => {
